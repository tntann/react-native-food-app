...
const dataIcons = [
  ...
  { key: 19, name: "Combo 199k", source: require("@/assets/icons/salad.png") },
  { key: 20, name: "Milk Tea", source: require("@/assets/icons/Notif.png") },
];
    ...
    <View>
      ...
      >
        <FlatList
          ...
          numColumns={Math.ceil(dataIcons.length / 2)}
